...
const perguntas = [
...

    {
        ...
        alternativas: [
            ...
            {
                texto: "A invasão da União Soviética",
                correta: false
            }
        ]
    },
...

    {
        ...
        alternativas: [
            {
                texto: "A invasão da Polônia",
                correta: false
            },
            {
                texto: "A Batalha de Stalingrado",
                correta: false
            },
            {
                texto: "O ataque japonês a Pearl Harbor",
                correta: true
            },
            {
                texto: "A invasão da França",
                correta: false
            }
        ]
    },
...

    {
        ...
        alternativas: [
            ...
            {
                texto: "A invasão alemã da União Soviética",
                correta: false
            }
        ]
    },

    {
        ...
        alternativas: [
            ...
            {
                texto: "Batalha de Waterloo",
                correta: false
            },
            {
                texto: "Batalha de Hastings",
                correta: false
            },
            {
                texto: "Batalha de Trafalgar",
                correta: false
            }
        ]
    },
...

    {
        ...
        alternativas: [
            {
                texto: "Tóquio e Osaka",
                correta: false
            },
            {
                texto: "Kyoto e Tóquio",
                correta: false
            },
            {
...
function mostraResultado() {
    ...
    if (porcentagem === 100) {
        ...
        mensagemResultado.textContent =
            "🏆 Perfeito! Você é um verdadeiro especialista em Segunda Guerra Mundial!";

    } else if (porcentagem >= 80) {

        mensagemResultado.textContent =
            "👏 Excelente! Você conhece muito bem a história da Segunda Guerra Mundial.";

    } else if (porcentagem >= 60) {

        mensagemResultado.textContent =
            "👍 Muito bom! Você tem bons conhecimentos sobre o assunto.";

    } else if (porcentagem >= 40) {

        mensagemResultado.textContent =
            "📚 Não foi mal! Mas ainda dá para estudar um pouco mais.";

    } else {

        mensagemResultado.textContent =
            "📖 Que tal estudar um pouco mais sobre a Segunda Guerra Mundial e tentar novamente?";
